...
var AutoCompleteSuggestionItemWithContext = function AutoCompleteSuggestionItemWithContext(_ref) {
  ...
  if (triggerType === 'mention') {
    ...
    }, name || id)), _react["default"].createElement(_AtMentions.AtMentions, {
    ...
    }, _react["default"].createElement(_AutoCompleteSuggestionCommandIcon.AutoCompleteSuggestionCommandIcon, {
      name: _name2,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
    ...
    }, (_name2 || '').replace(/^\w/, function (_char) {
...
var AutoCompleteSuggestionItem = function AutoCompleteSuggestionItem(props) {
  return _react["default"].createElement(MemoizedAutoCompleteSuggestionItem, (0, _extends2["default"])({}, props, {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 146,
