...
var renderText = function renderText(params) {
  ...
  var urls = (0, _parseLinks.parseLinksFromText)(newText);

  for (var _iterator = _createForOfIteratorHelperLoose(urls), _step; !(_step = _iterator()).done;) {
    var urlInfo = _step.value;
    var displayLink = (0, _truncate["default"])(urlInfo.encoded, {
      length: 200,
      omission: '...'
    });
    var markdown = "[" + displayLink + "](" + urlInfo.scheme + urlInfo.encoded + ")";
...
var Bullet = function Bullet(_ref5) {
  ...
  return _react["default"].createElement(_reactNative.Text, {
    key: 0,
    style: [style, defaultMarkdownStyles.listItemNumber],
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 353,
...
var ListRow = function ListRow(props) {
  return _react["default"].createElement(_reactNative.Text, {
    style: [props.style, defaultMarkdownStyles.listRow],
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 359,
