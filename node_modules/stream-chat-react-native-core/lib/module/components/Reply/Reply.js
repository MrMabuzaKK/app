...
var ReplyWithContext = function ReplyWithContext(props) {
  ...
  return _react["default"].createElement(_reactNative.View, {
    ...
    message: (0, _extends2["default"])({}, quotedMessage, {
      text: quotedMessage.deleted_at ? "_" + t('Message deleted') + "_" : quotedMessage.text ? quotedMessage.text.length > 170 ? quotedMessage.text.slice(0, 170) + "..." : quotedMessage.text : messageType === 'image' ? t('Photo') : messageType === 'video' ? 'Video' : messageType === 'file' ? (lastAttachment == null ? void 0 : lastAttachment.title) || '' : ''
    }),
