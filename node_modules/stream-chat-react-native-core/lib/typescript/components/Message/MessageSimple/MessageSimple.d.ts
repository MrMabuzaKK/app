...
export declare const MessageSimple: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<MessageSimplePropsWithContext<StreamChatGenerics>>): JSX.Element;
    displayName: string;
};
