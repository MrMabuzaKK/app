...
var InputEditingStateHeaderWithContext = function InputEditingStateHeaderWithContext(_ref) {
  ...
  }, _react["default"].createElement(_icons.Edit, {
  ...
  }, t('Editing Message')), _react["default"].createElement(_reactNative.TouchableOpacity, {
    disabled: disabled,
...
var InputEditingStateHeader = function InputEditingStateHeader(props) {
  ...
  return _react["default"].createElement(MemoizedInputEditingStateHeader, (0, _extends2["default"])({
