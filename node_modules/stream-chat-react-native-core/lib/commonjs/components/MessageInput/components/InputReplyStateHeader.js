...
var InputReplyStateHeaderWithContext = function InputReplyStateHeaderWithContext(_ref) {
  ...
  }, t('Reply to Message')), _react["default"].createElement(_reactNative.TouchableOpacity, {
    disabled: disabled,
...
var InputReplyStateHeader = function InputReplyStateHeader(props) {
  ...
  return _react["default"].createElement(MemoizedInputReplyStateHeader, (0, _extends2["default"])({
