...
describe('list', function () {
  ...
  var MockText = function MockText(_ref2) {
    var node = _ref2.node,
        output = _ref2.output,
        state = _ref2.state;
    return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_renderText.ListOutput, {
      node: node,
      output: output,
      state: state,
      styles: {},
  ...
  it('renders numbered items', function () {
    ...
    var _render = (0, _reactNative2.render)(_react["default"].createElement(MockText, {
      node: node,
      output: mockOutput,
      state: {},
      __self: _this,
    ...
    var textInstances = container.children;
  ...
  it('renders numbered items from a start index', function () {
    ...
    var _render2 = (0, _reactNative2.render)(_react["default"].createElement(MockText, {
      node: node,
      output: mockOutput,
      state: {},
      __self: _this,
  ...
  it('does not throw an error if an item is empty', function () {
    var node = (0, _extends2["default"])({}, createNode({
      amount: 3,
      ordered: true
    }), {
    ...
    var _render3 = (0, _reactNative2.render)(_react["default"].createElement(MockText, {
      node: node,
      output: mockOutput,
      state: {},
      __self: _this,
  ...
  it('renders an unordered list', function () {
    ...
    var _render4 = (0, _reactNative2.render)(_react["default"].createElement(MockText, {
      node: node,
      output: mockOutput,
      state: {},
      __self: _this,
